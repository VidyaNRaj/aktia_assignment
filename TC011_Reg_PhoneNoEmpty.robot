...
${expect_result}=    {'PhoneNumber': ['The PhoneNumber field is required.']}
${title}=    One or more validation errors occurred.


*** Test Cases ***
Registration with Phone Number Empty
    ...
    ${register_response}=  Post On Session  mysession  ${REGISTER_ENDPOINT}  data={"email": "${email}", "fullName": "test user", "phoneNumber": "", "password": "12345", "confirmPassword": "12345"}  headers=${headers}    expected_status=400
