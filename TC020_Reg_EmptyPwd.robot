...
${errorMessage}=    {'Password': ['The Password field is required.', 'The Password must be at least 5 characters long.'], 'ConfirmPassword': ['The ConfirmPassword field is required.']}
${title}=           One or more validation errors occurred.


*** Test Cases ***
Register with empty password and valid email
    ...
    ${register_response}=          Post On Session  mysession  ${REGISTER_ENDPOINT}  data={"email": "${email}", "fullName": "test user", "phoneNumber": "9415128845", "password": "", "confirmPassword": ""}  headers=${headers}    expected_status=400
