...
${expect_result}=    {'ConfirmPassword': ["'ConfirmPassword' and 'Password' do not match."]}
${title}=            One or more validation errors occurred.


*** Test Cases ***
Validate Different Password error message
    ...
    ${register_response}=  Post On Session  mysession  ${REGISTER_ENDPOINT}  data={"email": "${email}", "fullName": "test user", "phoneNumber": "9415128845", "password": "14445", "confirmPassword": "12345"}  headers=${headers}    expected_status=400
