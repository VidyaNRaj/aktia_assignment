...
Login with empty email and valid password
    ...
    ${login_response}=          Post On Session  mysession  ${LOGIN_ENDPOINT}  data={"email": "", "fullName": "test user", "phoneNumber": "9415128845", "password": "12345", "confirmPassword": "12345"}  headers=${headers}    expected_status=400
