...
*** Test Cases ***
Register New User with special character in phone number   #Valid email and password
    ...
    ${register_response}=  Post On Session  mysession  ${REGISTER_ENDPOINT}  data={"email": "${email}", "fullName": "test user", "phoneNumber": "#$$$$$$$$$$$$$$$$", "password": "12345", "confirmPassword": "12345"}  headers=${headers}
    ...
    ${expected_data}=  Create Dictionary  Id=5136  Email=${email}  FullName=test user  PhoneNumber=#$$$$$$$$$$$$$$$$
