...
${ErrorMessage}=    {'Email': ['The Email field is not a valid e-mail address.'], 'Password': ['The Password must be at least 5 characters long.']}
${title}=            One or more validation errors occurred.


*** Test Cases ***
Login Function with Invalid Email and Invalid password
    ...
    ${login_response}=    POST On Session  mysession  ${LOGIN_ENDPOINT}     data={"email": "123", "password": "1245"}    headers=${headers}    expected_status=400
